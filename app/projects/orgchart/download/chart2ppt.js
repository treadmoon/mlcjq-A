import KdPptx from '../../../../plugin/kdppt.es'
  ...
  cardModels.map((cardModel) => {
    ...
    switch (cardModel.tag) {
      ...
      case 'text':
        ...
        textInfo = resolveParams(cardModel.text, '', { node }).reduce((t1, t2) => t1 + t2, '')
        ...
        fontSize = (node.isMinFontSize ? cardModel.minFontSize : cardModel.fontSize) / 1.45
      ...
      case 'icon':
        ...
        fontSize = resolveParams(cardModel.fontSize, 12, { node }) / this.transcale
